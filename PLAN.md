...
- **Logo:** his actual logo, rebuilt as vector from the Yelp raster and the building signage: the shield emblem with the physician and caduceus, the wordmark with the virus in place of the O, tagline and name. Colours sampled from the original. The virus rotates slowly as the O in the site header and is the favicon; the full lockup sits in the footer and on the printable forms. Delivered as SVG and transparent PNG, colour and white, horizontal and stacked (`brand/`).
